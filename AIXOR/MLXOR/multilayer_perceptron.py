# Taken from scikit-learn 0.18. This is the same file as the scikit-version, but
# it differs in the multiple activation functions available
...
from base_functions import ACTIVATIONS, DERIVATIVES, LOSS_FUNCTIONS
